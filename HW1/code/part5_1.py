...
image_path = ("../ref/test_image_set/test.hdr") 
...
# save and show image
scipy.misc.imsave("../result/my_test_global_tone.png",img_global_tone_map)
#plt.figure()
...
# save and show image
scipy.misc.imsave("../result/my_test_gaussian.png",img_gaussian)
#plt.figure()
...
# save and show image
scipy.misc.imsave("../result/my_test_bilateral.png",img_bilateral)
#plt.figure()
...
# save and show image
scipy.misc.imsave("../result/my_test_global_wb.png",img_global_wb)
#plt.figure()
